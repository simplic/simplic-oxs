...
{
    public class OrganizationTransactionServiceBase<TDocument, TFilter> : IOrganizationTransactionServiceBase<TDocument, TFilter>
        ...
        where TFilter : IOrganizationFilter<Guid>
    {
        ...
        public OrganizationTransactionServiceBase(IOrganizationTransactionRepository<Guid, TDocument, TFilter> repository, IRequestContext requestContext)
        {
