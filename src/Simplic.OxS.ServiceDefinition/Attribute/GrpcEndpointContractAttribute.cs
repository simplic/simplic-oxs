...
public class GrpcEndpointContractAttribute : EndpointContractAttribute
{
    ...
    /// <param name="gprcService">gRPC service name</param>
    ...
    public GrpcEndpointContractAttribute([NotNull] string contractName, [NotNull] string serviceName, [NotNull] string grpcPackage, [NotNull] string gprcService, [NotNull] string grpcMethod, [NotNull] string providerName)
        : base(contractName, $"[gprc]http://{serviceName}:8082::{grpcPackage}.{gprcService}::{grpcMethod}", providerName)
    {
