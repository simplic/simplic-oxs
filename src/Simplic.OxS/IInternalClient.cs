...
namespace Simplic.OxS.Server
{
    ...
    public interface IInternalClient : IDisposable
    {
        ...
        Task<T?> Get<T>([NotNull] string host, [NotNull] string service, [NotNull] string controller, string action, IDictionary<string, string>? parameter = null);
        ...
        /// <returns>Result object</returns>
        /// <exception cref="Exception"></exception>
        Task<T?> Post<T, O>([NotNull] string host, [NotNull] string service, [NotNull] string controller, string action, O body, IDictionary<string, string>? parameter = null);
        ...
        /// <returns>Result object</returns>
        /// <exception cref="Exception"></exception>
        Task<T?> Put<T, O>([NotNull] string host, [NotNull] string service, [NotNull] string controller, string action, O body, IDictionary<string, string>? parameter = null);
        ...
        /// <returns>Result object</returns>
        /// <exception cref="Exception"></exception>
        Task<T?> Delete<T>([NotNull] string host, [NotNull] string service, [NotNull] string controller, string action, IDictionary<string, string>? parameter = null);
